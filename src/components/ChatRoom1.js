...
import { ListView, View, Text, Alert, TextInput, Keyboard, Platform, TouchableHighlight, Image, StyleSheet } from 'react-native';
...
class ChatRoom1 extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <Image source={require('../images/r1.jpg')}
